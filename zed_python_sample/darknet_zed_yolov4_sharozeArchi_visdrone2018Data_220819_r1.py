...
# YoloV3 originalArch
lib = CDLL("/home/manzat/code/usim_code/localization/0_wip/jetson_yolov4_zed2_try1_220721/darknet_yolov4_sharozeArchi_visdrone2018Data_220819_r1/libdarknet.so", RTLD_GLOBAL)
...
def detect(net, meta, image, thresh=.1, hier_thresh=.1, nms=.45, debug=False):
    """
...
def main(argv):
    ...
    thresh = 0.10
    darknet_path = "../darknet_yolov4_sharozeArchi_visdrone2018Data_220819_r1/"
    config_path = darknet_path + "cfg/visdrone_yolo_v4_sherozeModified.cfg"
    weight_path =  darknet_path + "visdrone_yolo_v4_modified.weights"
    meta_path = "coco.data"
    svo_path = None
    zed_id = 0
    ...
    while key != 113:  # for 'q' key
        ...
        if err == sl.ERROR_CODE.SUCCESS:
            ...
            for detection in detections:
                ...
                cv2.putText(image,"" + "x" + (str(round(x, 2))) + "" + "y"+(str(round(y, 2))) + "" + "z" + (str(round(z, 2))),
